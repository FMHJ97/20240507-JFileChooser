...
public class PanelSelectFilesBySizeAndFilter extends JPanel {
	...
	// Elementos de los componentes de filtrado por texto.
	 ...
	 * Create the panel.
	 */
	public PanelSelectFilesBySizeAndFilter() {
		...
		lblNewLabel_2 = new JLabel("Texto en nombre:");
		lblNewLabel_2.setFont(new Font("Tahoma", Font.PLAIN, 15));
		GridBagConstraints gbc_lblNewLabel_2 = new GridBagConstraints();
		gbc_lblNewLabel_2.anchor = GridBagConstraints.EAST;
		gbc_lblNewLabel_2.insets = new Insets(10, 0, 20, 5);
		gbc_lblNewLabel_2.gridx = 0;
		gbc_lblNewLabel_2.gridy = 4;
		add(lblNewLabel_2, gbc_lblNewLabel_2);
		
		jtfFiltro = new JTextField();
		jtfFiltro.setFont(new Font("Tahoma", Font.PLAIN, 15));
		jtfFiltro.setColumns(10);
		GridBagConstraints gbc_jtfFiltro = new GridBagConstraints();
		gbc_jtfFiltro.insets = new Insets(10, 0, 20, 5);
		gbc_jtfFiltro.fill = GridBagConstraints.HORIZONTAL;
		gbc_jtfFiltro.gridx = 1;
		gbc_jtfFiltro.gridy = 4;
		add(jtfFiltro, gbc_jtfFiltro);
		
		btnFiltrar = new JButton("Filtrar Ficheros");
		btnFiltrar.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				if (ficheros != null) {
					loadFilteredFilesByText();
				}
			}
		});
		btnFiltrar.setFont(new Font("Tahoma", Font.PLAIN, 15));
		GridBagConstraints gbc_btnFiltrar = new GridBagConstraints();
		gbc_btnFiltrar.gridwidth = 2;
		gbc_btnFiltrar.insets = new Insets(10, 0, 20, 5);
		gbc_btnFiltrar.gridx = 2;
		gbc_btnFiltrar.gridy = 4;
	 ...
	 * 
	 */
	private void loadFilteredFilesByText() {
		...
		table = new JTable(DatosDeTabla.getDatosDeTabla(filteredFiles),
				DatosDeTabla.getTitulosColumnas());
		scrollPane.setViewportView(table);
		
		// Mostramos el número de ficheros obtenidos.
		this.lbNumFiles.setText("(" + filteredFiles.size() + " ficheros)");
	}
